...
<?php 
	...
	$sql = mysqli_query ($dbConn, "select * from isi_berita where id_kategori=1 order by id_berita DESC");
					...
					<div class="panel panel-body">
						...
						<table>
							...
							<tr>
								...
								<td align='right'>
									<?php
										echo "<br><a href='index.php?menu=detail_laptop&id=$data[id_berita]' class='btn btn-primary btn-sm'>Read More</a>";
									?>
								</td>
							</tr>
						</table>
